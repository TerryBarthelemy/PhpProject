                        ...
                        <table class="table table-dark col table-style cases-table">  
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="user_case_details.php?case_id=<?php echo $row["case_id"]; if(isset($_GET["message_id"])){ echo "&message_id=".$_GET["message_id"]; } ?>"; ?><?php echo $row["case_title"]; ?></a></td>
                                </tr>
                                <?php endforeach; ?>
                    ...
                    <?php if(isset($employee_id)): ?>
                        <table class="table table-dark table-style">
                            ...
                            <tbody>
                                <?php foreach($messages as $message): ?>
                                    <tr>
                                        <td><a href="user_case_details.php?<?php if(isset($case_id)){echo "case_id=".$case_id."&";} ?>message_id=<?php echo $message["message_id"]; ?>"><?php echo $message["sender"]; ?></a></td>
