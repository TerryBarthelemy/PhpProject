<?php
    ...
    if (isPostRequest() && $action == "Add") 
    {
        ...
        if($password != ""){
            $result = addEmployeeWithoutPassword($firstname, $lastname, $job_title, $email, $phone, $photo, $case_id);
        }
                ...
                <div class="box-container">
                    ...
                    <form class="form-horizontal" action="#" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">          
                                <input style="width:350px;" type="text" class="form-control" id="email" placeholder="Enter Employee E-Mail" name="email">
                            </div>
                        </div>
                        <div class="form-group">
