                            ...
                            <?php if(isset($_GET["recipient_id"])): ?>
                                <?php foreach($messages as $row): ?>
                                    <?php if($row["employee_id"] == $recipient): ?>
                                        <tr>
                                            <td><a href="user_messages.php?message_id=<?php echo $row["message_id"] ?><?php if(isset($_GET["recipient_id"])){ echo "&"."recipient_id=".$_GET["recipient_id"]; } ?>"><?php echo substr($row["content"],0,30);?></a></td>
            ...
            <div class="black-box">
                ...
                <table class="table table-dark table-style">
                        ...
                        <tbody >
                            <?php foreach($employees as $employee): ?>
                                <tr>
                                    <td><a href="user_messages.php?recipient_id=<?php echo $employee["employee_id"]; ?><?php if(isset($_GET["message_id"])){ echo "&"."message_id=".$_GET["message_id"]; } ?>"><?php echo $employee["firstname"]." ".$employee["lastname"]; ?></a></td>
